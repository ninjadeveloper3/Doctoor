...
class MBAlertAction: NSObject, NSCopying {

    // MARK: - MBAlertAction Properties

    var title: String
    var style: MBAlertActionStyle

    var handler: (MBAlertAction) -> Void

    // MARK: - MBAlertAction init - & copy

    required init(title: String, style: MBAlertActionStyle, handler: @escaping (MBAlertAction) -> Void) {
        self.title = title
        self.style = style
...
class MBAlertPresentAnimationController: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        let alertViewController = transitionContext.viewController(forKey: UITransitionContextViewControllerKey.to)! as! MBAlertViewController
...
class MBAlertDismissAnimationController: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        let alertViewController = transitionContext.viewController(forKey: UITransitionContextViewControllerKey.from)! as! MBAlertViewController
...
class MBAlertViewController: UIViewController, UITextFieldDelegate {
    ...
    fileprivate var alertStyle: MBAlertStyle
    fileprivate var actions: [MBAlertAction]
...
//        registerNotifications()
    ...
    convenience init(title: String, iconImageName: String? = nil, message: String, messageFont: UIFont = UIFont.appThemeFontWithSize(15.0), style: MBAlertStyle) {
        self.init()
    ...
    func setupViewController() {
        ...
        titleLabel.font = UIFont.appThemeFontWithSize(15.0)
    ...
    func addAction(_ action: MBAlertAction) {
...
//        NotificationCenter.default.addObserver(self, selector: #selector(MBAlertViewController.keyboardDidShow(_:)), name: NSNotification.Name.UIResponder.keyboardWillShowNotification, object: nil)
//        NotificationCenter.default.addObserver(self, selector: #selector(MBAlertViewController.keyboardWillHide(_:)), name: NSNotification.Name.UIResponder.keyboardWillHideNotification, object: nil)
//    }
...
extension MBAlertViewController: UIViewControllerTransitioningDelegate {

    func animationController(forPresented presented: UIViewController, presenting: UIViewController, source: UIViewController) -> UIViewControllerAnimatedTransitioning? {

        let alertPresentAnimationController = MBAlertPresentAnimationController()

        return alertPresentAnimationController
    }

    func animationController(forDismissed dismissed: UIViewController) -> UIViewControllerAnimatedTransitioning? {
        let alertDismissAnimationController = MBAlertDismissAnimationController()
