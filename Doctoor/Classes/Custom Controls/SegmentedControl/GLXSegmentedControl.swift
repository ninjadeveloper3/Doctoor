...
extension UILabel {
    ...
    func fontFitsCurrentFrame(_ font:UIFont) -> Bool {
        let attributes = [NSAttributedString.Key.font: UIFont.appThemeFontWithSize(13.0)]
...
open class GLXSegmentedControl: UIControl {
    ...
    open override func layoutSubviews() {
        ...
        labelFontAdj: if enforceEqualFontForLabels {
            ...
            segmentAppearance.titleOnSelectionFont = UIFont.appThemeFontWithSize(15.0)
            segmentAppearance.titleOffSelectionFont = UIFont.appThemeFontWithSize(15.0)
            for segment in segments {
