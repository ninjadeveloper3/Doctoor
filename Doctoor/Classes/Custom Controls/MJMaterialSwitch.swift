...
class MJMaterialSwitch: UIControl {
    ...
    convenience init(withSize size: MJMaterialSwitchSize, state: MJMaterialSwitchState) {
        ...
        case .small:
            frame = CGRect(x: 0, y: 0, width: 45, height: 40)
            self.init(frame: frame)
            self.trackThickness = 18.0
            self.thumbSize = 18.0
            break
        }

        // initialize parameters
        self.thumbOnTintColor  = UIColor.switchThumbOnTintColor() //UIColor(red:52.0 / 255.0, green:109.0 / 255.0, blue:241.0 / 255.0, alpha:1.0)
//        self.thumbOffTintColor = UIColor(red:249.0 / 255.0, green:249.0 / 255.0, blue:249.0 / 255.0, alpha:1.0)
        self.thumbOffTintColor = UIColor.switchThumbOffTintColor()
        
        self.trackOnTintColor = UIColor.switchThumbOnTintColor() //UIColor(red:143.0 / 255.0, green:179.0 / 255.0, blue:247.0 / 255.0, alpha:1.0)
        self.trackOffTintColor = UIColor.switchThumbOnTintColor() //UIColor(red:193.0 / 255.0, green:193.0 / 255.0, blue:193.0 / 255.0, alpha:1.0)
    ...
    convenience init(withSize size: MJMaterialSwitchSize, style: MJMaterialSwitchStyle, state: MJMaterialSwitchState) {
        ...
        switch style {
        case .light:
            self.thumbOnTintColor  = UIColor.white
            self.thumbOffTintColor = UIColor.white
            self.trackOnTintColor = UIColor(red:58.0/255.0, green:215.0/255.0, blue:130.0/255.0, alpha:1.0)
            self.trackOffTintColor = UIColor(red:13.0/255.0, green:78.0/255.0, blue:78.0/255.0, alpha:1.0)
